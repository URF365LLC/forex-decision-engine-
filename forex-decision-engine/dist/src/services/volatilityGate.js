 ...
 */
export function checkVolatility(symbol, currentAtr, atrHistory) {
 ...
 */
export function getVolatilityLabel(level) {
    switch (level) {
 ...
 */
export function getVolatilityColor(level) {
    switch (level) {
...
//# sourceMappingURL=volatilityGate.js.map