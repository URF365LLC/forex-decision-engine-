...
import { getLatestValue, calculateSlope } from './indicatorService.js';
...
// HELPERS
// ═══════════════════════════════════════════════════════════════
function createNoTrendResult(price, ema200, adx, slope, reason) {
    return {
        direction: 'none',
        price,
        ema200: ema200 ?? 0,
...
//# sourceMappingURL=trendFilter.js.map