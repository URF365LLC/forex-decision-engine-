...
// ═══════════════════════════════════════════════════════════════════════════
// NO-TRADE DECISION HELPER
// ═══════════════════════════════════════════════════════════════════════════

import { Decision, StrategyMeta } from './types.js';

export function createPreflightRejection(
  symbol: string,
  ...
  return {
    ...
    direction: 'long', // Direction is unknown for preflight rejections; 'long' is a safe neutral placeholder for no-trade
    grade: 'no-trade',
    confidence: 0,
    entryPrice: 0,
    ...
    takeProfit: null,
    position: null,
    reason: preflight.rejectReason || 'Preflight check failed',
    triggers: [],
    reasonCodes: [],
    warnings: preflight.warnings,
    style: strategyMeta.style, // Use strategy's style from metadata
    executionModel: 'NEXT_OPEN',
    timeframes: strategyMeta.timeframes,
