 ...
 */
export function isValid(validUntilIso: string): boolean {
...
export function getSessionInfo(): {
  ...
  // Next session
  let nextSession = '';
  if (utcHour < 7) nextSession = 'London opens at 07:00 UTC';
  else if (utcHour < 12) nextSession = 'New York opens at 12:00 UTC';
  else if (utcHour < 21) nextSession = 'Sydney opens at 21:00 UTC';
  else nextSession = 'Tokyo opens at 00:00 UTC';
